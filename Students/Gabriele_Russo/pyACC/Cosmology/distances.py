...
def comoving_distance(z, H, Omega_mat, H_0):
        return simpsons_rule(lambda z : Integrand_comoving_distance(z, H, Omega_mat, H_0), 0, z, 100000) #with lambda z : function, we are reducing the function only with z as variable

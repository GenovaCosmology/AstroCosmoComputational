...
def comoving_distance(z, H, Omega_mat, H_0):
        return trapezoid(lambda z : Integrand_comoving_distance(z, H, Omega_mat, H_0), 0, z, 0.0001) #with lambda z : function, we are reducing the function only with z as variable
